...
You can download the checkpoints from [Google Drive](https://drive.google.com/file/d/1cPona0MKVls4ZXsDXq6URsb5TePUS48B/view?usp=drive_link). After obtaining the files, follow the steps below to organize them:
